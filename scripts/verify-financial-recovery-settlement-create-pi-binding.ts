...
assert.deepEqual(bindSettlementCreatePiToDecision({ decisionInput: baseDecision, pi: { ...base, expected: { branch: "REFUND", paymentId: "payment-1", refundId: "r", idempotencyKey: "i", amount: 2.5, payerUid: "p" }, candidates: [] } }), { authorizesFinancialAction: false, outcome: "BLOCKED", reason: "PI_EVIDENCE_UNVERIFIED" })
