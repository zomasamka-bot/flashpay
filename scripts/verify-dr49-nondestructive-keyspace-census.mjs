...
for(const x of ['DR10_KEYSPACE_CENSUS_MODE = "dr10-keyspace-census"','const censusOnly=dr10Mode===DR10_KEYSPACE_CENSUS_MODE','unknownNamespaceCounts','unknownSuffixShapeCounts','[DR49 DR10 NONDESTRUCTIVE KEYSPACE CENSUS]','deletionAttempted:false']) assert.ok(r.includes(x),x);
