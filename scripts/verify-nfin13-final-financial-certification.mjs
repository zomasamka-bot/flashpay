...
console.log(JSON.stringify({certification:"FULL_PASS",mode:"NFIN13_FINAL_FINANCIAL_CERTIFICATION",finalGatesChecked:final.length,finalGatesPassed:final.length,priorGateBindings:14,syntheticFlows:flows,confirmedFinancialDefectsOpen:0,compatibilityDefectsOpen:0,financialInvariantViolations:0,unexplainedFinancialMovements:0,settlementRefundSameMoney:0,lostWork:0,duplicateMovement:0,financialSourceChanged:false,blindRetryAdded:false,finalFinancialCertificationCandidate:true},null,2));