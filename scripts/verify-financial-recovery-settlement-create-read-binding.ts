...
assert.deepEqual(evaluateFinancialRecoverySettlementCreateReadBinding({ ...baseInput, read: { outcome: "INDETERMINATE", reason: "U2A_READ_FAILED" } }), { authorizesFinancialAction: false, outcome: "BLOCKED", reason: "READ_UNVERIFIED" })
