...
assert.ok(complete.indexOf('createDr11RefundAuthorityFromDurableHold(preFlashPaymentId)') < complete.indexOf('const atomicU2AResult = await redis.eval(`'))
