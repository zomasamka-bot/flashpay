...
for(const x of [
  'FLASHPAY_DR11_LIVE_CONCURRENT_REFUND_TEST === "1"', 'finalPiPayment.network === "Pi Testnet"', 'finalPiAmount === 0.1',
...
assert.ok(complete.indexOf('recordSettlementU2ACompletedCheckpoint') < complete.indexOf('dr11RefundCertificationContext'), 'Pi durable completion must precede DR11 projection authority')
