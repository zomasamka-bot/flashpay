...
console.log(JSON.stringify({certification:"PASS",mode:"NFIN12_CROSS_SYSTEM_FINALITY_CERTIFICATION_ONLY",matrixChecks:matrix.length,matrixPassed:matrix.length,syntheticFlows:flows,lostWork:lost,duplicateMovement:duplicates,settlementRefundOverlap:overlap,financialSourceChanged:false,blindRetryAdded:false,nextGate:"N-FIN-13"},null,2));