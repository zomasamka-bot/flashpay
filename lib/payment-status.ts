...
export function isPaymentFinal(payment: Payment): boolean {
  ...
  const netImpactValid = typeof payment.appNetImpact === "number" && typeof payment.customerAmount === "number" && typeof payment.merchantAmount === "number" && typeof payment.horizonFeeCharged === "number" && Number.isFinite(payment.appNetImpact) && payment.appNetImpact === payment.customerAmount - payment.merchantAmount - payment.horizonFeeCharged
