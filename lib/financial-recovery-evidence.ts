...
const IDS_AND_SETTLEMENT_FLAGS: readonly EvidenceFact[] = [
  "pi_payment_id_present", "u2a_txid_present", "a2u_payment_id_present", "a2u_txid_present", "refund_id_present", "refund_payment_id_present", "refund_txid_present",
  "settlement_local_status_flag", "settlement_local_completion_flag", "refund_local_status_flag", "refund_local_completion_flag",
]

const SETTLEMENT_CONFLICTS: readonly EvidenceFact[] = [
  "refund_payment_id_present", "refund_txid_present", ...REFUND_FACTS,
  "refund_local_status_flag", "refund_local_completion_flag",
]

const REFUND_CONFLICTS: readonly EvidenceFact[] = [
  "a2u_payment_id_present", "a2u_txid_present", ...SETTLEMENT_FACTS,
  "settlement_local_status_flag", "settlement_local_completion_flag",
]

const REFUND_ELIGIBILITY_FACTS = [
  ...APP_FUNDS_FACTS,
  "verified_payer", "verified_amount", "merchant_a2u_confirmed_none",
  "merchant_transfer_evidence_absent", "refund_transfer_evidence_absent", "refund_eligibility_proof_exact",
] as const

const REFUND_BASE_FACTS = [
  ...APP_FUNDS_FACTS,
  "refund_eligibility_proof_exact", "merchant_transfer_evidence_absent",
] as const
...
export const FINANCIAL_EVIDENCE_MATRIX: Readonly<Record<EvidencedState, EvidenceRule>> = {
  ...
  refund_eligible: { requiresAll: REFUND_ELIGIBILITY_FACTS, insufficientAlone: IDS_AND_SETTLEMENT_FLAGS, conflictsWith: REFUND_CONFLICTS, onUncertainty: "unknown" },
  refund_created: { requiresAll: [...REFUND_BASE_FACTS, ...REFUND_FACTS.slice(0, 1)], insufficientAlone: IDS_AND_SETTLEMENT_FLAGS, conflictsWith: REFUND_CONFLICTS, onUncertainty: "unknown" },
  refund_blockchain_confirmed: { requiresAll: [...REFUND_BASE_FACTS, ...REFUND_FACTS.slice(0, 2)], insufficientAlone: IDS_AND_SETTLEMENT_FLAGS, conflictsWith: REFUND_CONFLICTS, onUncertainty: "unknown" },
  refund_pi_completed: { requiresAll: [...REFUND_BASE_FACTS, ...REFUND_FACTS.slice(0, 3)], insufficientAlone: IDS_AND_SETTLEMENT_FLAGS, conflictsWith: REFUND_CONFLICTS, onUncertainty: "unknown" },
  refund_finalized: { requiresAll: [...REFUND_BASE_FACTS, ...REFUND_FACTS], insufficientAlone: IDS_AND_SETTLEMENT_FLAGS, conflictsWith: REFUND_CONFLICTS, onUncertainty: "unknown" },
}
