...
export function evaluateRefundPreparedReplayPreGate(input: { sourcePayment: Payment; payment: RefundPiPayment; prepared: Awaited<ReturnType<typeof readRefundPreparedSubmitState>>; evidence: ReturnType<typeof evaluateRefundPreparedRecoveryEvidence> }): { outcome: "ELIGIBLE_EXACT_REPLAY" | "BLOCKED"; prepared: Awaited<ReturnType<typeof readRefundPreparedSubmitState>> | null; observedSourceSequence: string | null; reference: ReturnType<typeof evaluateRefundPreparedRecoveryEvidence>["reference"]; moneyMovementProven: false; authorizesFinancialAction: false } {
