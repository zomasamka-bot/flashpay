    ...
    <div className="min-h-screen pb-20 pt-4">
      <div className="max-w-4xl mx-auto px-4 space-y-6">
        ...
        <Card className="border-2 border-primary">
          ...
          <CardContent>
            <Button onClick={() => router.push(ROUTES.CONTROL_PANEL)} className="w-full" size="lg">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Monitor wallet-to-wallet fund transfers and settlement status</CardDescription>
          </CardHeader>
          <CardContent>
            <Button onClick={() => router.push("/merchant/transfers")} className="w-full" size="lg" variant="outline">
